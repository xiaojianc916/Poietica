import { AssistantThreadList } from '@hybrid-canvas/ai/react'
import type { AssistantThreadSummary } from '@hybrid-canvas/ai/react'
import type { WorkspacePanelRenderers } from '@hybrid-canvas/workspace/contracts'
...
const FIXTURE: readonly AssistantThreadSummary[] = [
  ...
  { id: 't4', title: 'Hybrid Canvas 架构总结', relativeTime: '1 小时', group: '今天' },
