import { EditorProvider } from '@poietica/canvas/react'
import { applyThemePreference, ConfirmationDialog } from '@poietica/design-system'
import type { MainWindowController } from '@poietica/platforms-desktop-runtime'
import type { SettingsStore } from '@poietica/settings'
import { SettingsDialog } from '@poietica/settings/react'
...
import { CommandPalette } from '@poietica/workspace/react'
