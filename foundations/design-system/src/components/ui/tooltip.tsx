...
>(({ className, sideOffset = 4, side, ...props }, ref) => (
  <Tooltip.Portal>
    ...
    >
      <Tooltip.Popup
        className={cn(
          'overflow-hidden rounded-md bg-neutral-700 dark:bg-neutral-200 px-3 py-1.5 text-xs text-neutral-50 dark:text-neutral-800 animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
          className,
        )}
        ref={ref}
        {...props}
